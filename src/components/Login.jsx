    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    <button className='btn-primary text-white font-bold py-2 px-4 rounded focus:outline-none'>Login</button>
                </div>
            </form>
            <p className='align-baseline font-medium mt-4 text-sm'>¿No tenés un cuenta? Por favor <Link to="/register" className="text-orange-400 hover:text-green-200">Registrate</Link></p>
            <div className='mt-4'>
                <button 
