  ...
  return (
        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <span className="block text-gray-500">Productos de tendencia este mes</span>
                </div>
                </div>
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                ...
                <div className="px-6 py-5 font-semibold border-b border-gray-100">El número de pedidos por mes</div>
                ...
                <div>
                    ...
                    <span className="block text-gray-500">Pedidos pendientes</span>
                </div>
                </div>
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span className="block text-gray-500">Visitas al sitio web (último día)</span>
                </div>
                </div>
