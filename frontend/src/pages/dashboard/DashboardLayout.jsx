...
return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
        <a href="/" className="inline-flex items-center justify-center h-20 w-20 bg-emerald-200 hover:bg-emerald-300 focus:bg-emerald-200">
        <img src={Logo} alt="Logo" className="mt-5 mb-5 w-64" />
        </a>
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
            ...
            <Link to="/dashboard" className="inline-flex items-center justify-center py-3 text-emerald-600 bg-white rounded-lg">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
        ...
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            <div className="mr-6">
            <h1 className="text-4xl font-semibold mb-2">Panel</h1>
            <h2 className="text-gray-600 ml-0.5">Inventario de la tienda de productos</h2>
            </div>
            <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
            <Link to="/dashboard/manage-products" className="inline-flex px-5 py-3 text-emerald-400 hover:text-emerald-400 focus:text-emerald-400 hover:bg-emerald-100 focus:bg-emerald-100 border border-emerald-400 rounded-md mb-3">
                <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
                Gestionar producto
            </Link>
            <Link to="/dashboard/add-new-product" className="inline-flex px-5 py-3 text-white bg-emerald-400 hover:bg-emerald-400 focus:bg-emerald-400 rounded-md ml-6 mb-3">
